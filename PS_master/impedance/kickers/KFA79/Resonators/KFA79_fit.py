'''
Fitting the KFA79 kicker impedance with resonators
...
print(fittedParameters)
# Plotting the result with four resonators
plt.figure('Impedance')
plt.plot(impedParams.resonatorForFit.frequency_array/1e6,
         np.abs(impedParams.resonatorForFit.impedance),
         label='3 low freq (+1 BB) Resonators')
plt.xlabel('Frequency [MHz]')
plt.ylabel('Impedance [$\\Omega$]')
plt.legend(loc='best')
plt.tight_layout()
...
# plt.plot(impedParams.resonatorForFit.frequency_array/1e6,
#          np.abs(impedParams.resonatorForFit.impedance),
#          label='Combined 6 Resonators (better low freq)')
# plt.xlabel('Frequency [MHz]')
# plt.ylabel('Impedance [$\\Omega$]')
# plt.legend(loc='best')
# plt.tight_layout()
