'''
Fitting the BFA09 kicker impedance with resonators
...
plt.plot(impedParams.resonatorForFit.frequency_array/1e6,
         np.abs(impedParams.resonatorForFit.impedance),
         label='3 low freq (+2 BB) Resonators')
plt.xlabel('Frequency [MHz]')
plt.ylabel('Impedance [$\\Omega$]')
plt.legend(loc='best')
plt.tight_layout()
...
fittedParameters = impedParams.fitResonators(np.append(fittedParameters_lowfreq[0][2:],
                                                       fittedParameters_BB[0]),
                                             np.append(fittedParameters_lowfreq[1][2:],
                                                       fittedParameters_BB[1]),
                                             np.append(fittedParameters_lowfreq[2][2:],
...
# plt.plot(impedParams.resonatorForFit.frequency_array/1e6,
#          np.abs(impedParams.resonatorForFit.impedance),
#          label='Combined 5 Resonators (better broadband)')
# plt.xlabel('Frequency [MHz]')
# plt.ylabel('Impedance [$\\Omega$]')
# plt.legend(loc='best')
# plt.tight_layout()
