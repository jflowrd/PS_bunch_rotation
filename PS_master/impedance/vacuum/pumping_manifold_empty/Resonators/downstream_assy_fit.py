...
fittedParameters = impedParams.fitResonators(np.append(fittedParameters[0], [3399, 700]),
                                             np.append(fittedParameters[1], [1.457e9, 1.362e9]),
                                             np.append(fittedParameters[2], [3529, 3400]),
                                             RShuntScale=1e4,
                                             freqScale=1e9,
                                             QScale=1e3,
                                             fitResidue='lin_total',
...
plt.plot(impedParams.resonatorForFit.frequency_array/1e6,
         ...
         label='%d Resonators and ImZ/f' % (len(fittedParameters[0])))
plt.xlabel('Frequency [MHz]')
plt.ylabel('Impedance [$\\Omega$]')
plt.legend(loc='best')
