'''
Fitting the pumping manifolds (with CODD inserted) impedance with resonators
...
# Second iteration fine tuning with ImZ/n
...
np.savetxt(script_path+'/multi_resonator_and_ImZ_over_f.txt',
           saved_matrix, header='Impedance of MU downstream assembly with CODD\n' +
