...
# fittedParameters = impedParams.fitResonators(np.append(fittedParameters[0], [1000]),
#                                              np.append(fittedParameters[1], [1.415e9]),
#                                              np.append(fittedParameters[2], [300]),
#                                              RShuntScale=1e4,
#                                              freqScale=1e9,
#                                              QScale=1e3,
...
np.savetxt(script_path+'/multi_resonator_and_ImZ_over_f.txt',
           saved_matrix, header='Impedance of the internal dump\n' +
