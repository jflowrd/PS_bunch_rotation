...
'''
note = ' *** Newer version in PS_master ***'
...
if plot_impeadance:
    ...
    toolbox_path = script_path + '/PS_master/impedance_toolbox'

    # Case selector
    model = 'top'  # top, trisplit
    beam = 'LHC25ns_flat_top_after_four_split'
    ...
    PS_loader.importImpedancePS() # Added 22/04/2024
